...
$videos = [
    [
        "title" => "10-Min Guided Meditation for Stress Relief",
        "thumbnail" => "https://img.youtube.com/vi/inpok4MKVLM/hqdefault.jpg",
        "url" => "https://www.youtube.com/watch?v=inpok4MKVLM"
    ],
    [
        "title" => "Deep Breathing Meditation",
        "thumbnail" => "https://img.youtube.com/vi/qzA7e0TNxYg/hqdefault.jpg",
        "url" => "https://www.youtube.com/watch?v=qzA7e0TNxYg"
    ],
    [
        "title" => "20-Min Mindfulness Meditation",
    ...
    [
        ...
        "thumbnail" => "https://img.youtube.com/vi/1vx8iUvfyCY/hqdefault.jpg",
...
<div class="app">
  ...
  <header>
    <div class="brand">
      <div class="logo-lluma">Meditation</div>
    ...
    <div style="display:flex;align-items:center;gap:18px;">
      <nav>
        ...
        <a href="neuro.php" style="background:rgba(255,255,255,0.05);">Neurowell Academy</a>
        <a href="calm.php">Calm Music</a>
        <a href="beats.php">Binoural Beats</a>
      </nav>
