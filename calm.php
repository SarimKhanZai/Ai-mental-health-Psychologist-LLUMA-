...
<div class="app">
  ...
  <header>
    <div class="brand">
      <div class="logo-lluma">Calm Music</div>
	...
	<a href="medi.php">Meditation</a>
        <a href="beats.php" style="background:rgba(255,255,255,0.05);">Binoral Beats</a>
